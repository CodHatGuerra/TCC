...
CREATE TABLE IF NOT EXISTS `mydb`.`TB_Vacina` (
  ...
  `Adicionado` VARCHAR(45) NOT NULL,
...
-- -----------------------------------------------------
-- Table `mydb`.`TB_Usuario_TB_Celular`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`TB_Usuario_TB_Celular` (
  `TB_Usuario_ID_Usuario` INT NOT NULL,
...
-- Table `mydb`.`TB_Posto`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`TB_Posto` (
  `ID_Instituicao` INT NOT NULL,
  `Registro_Governamental` VARCHAR(45) NOT NULL,
  `Cnpj` VARCHAR(45) NOT NULL,
  `TB_Endereco_ID_Endereco` INT NOT NULL,
  PRIMARY KEY (`ID_Instituicao`),
  UNIQUE INDEX `idTB_Instituição_UNIQUE` (`ID_Instituicao` ASC) VISIBLE,
  INDEX `fk_TB_POSTO_TB_Endereco1_idx` (`TB_Endereco_ID_Endereco` ASC) VISIBLE,
  UNIQUE INDEX `Cnpj_UNIQUE` (`Cnpj` ASC) VISIBLE,
  UNIQUE INDEX `Registro_UNIQUE` (`Registro_Governamental` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `mydb`.`TB_Funcionario_Posto`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`TB_Funcionario_Posto` (
  ...
  CONSTRAINT `fk_TB_Funcionario_has_TB_POSTO_TB_POSTO1`
    ...
    REFERENCES `mydb`.`TB_Posto` (`ID_Instituicao`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
